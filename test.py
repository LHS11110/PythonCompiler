...
from Modules.LexicalAnalyzer import LexicalAnalyze
...
print(input_txt)
print(
    Parser.cleanup(LexicalAnalyze.lexical_analyze(input_text=input_txt)),
    end="\n\n",
)

print(
    Syntax.getGenerator(
        Parser.cleanup(LexicalAnalyze.lexical_analyze(input_text=input_txt)), 0
    ),
    end="\n\n",
)
